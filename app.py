# app.py  –  加入 CV / Range / Pdiff 特征版 + gap 差值模式展示（两列对齐表格）
...
.gap-table{
  /* 去掉原来的 width: 60%; */
  width: auto;                          /* 让表宽度按内容自适应 */
  margin: 0.5rem auto 0.8rem auto;      /* 居中 */
  border-collapse: separate;
  border-spacing: 15px 4px;             /* 这行改成你要的 10px 4px */
}
.gap-table th{
  text-align: left;
  font-weight: 600;
...
# ───────── 基本常量 ─────────
DATA_FILE = "/Users/huanglu/Desktop/football_predictor/data/new_matches.xlsx"
